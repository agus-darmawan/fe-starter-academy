...
export const Select: React.FC<SelectProps> = ({
  ...
  return (
    <div className='relative z-30 w-full text-white'>
      <div
        className='text-md bg-blue-starter border-blue-backgraund flex min-w-full cursor-pointer flex-row items-center justify-between rounded-[20px] border-2 px-5  py-2'
      ...
      >
        ...
        <div>
          <div className='text-blue-starter rounded-full  bg-white'>
            <IconChevronDown
              className={`${
                showOptions
      ...
      {showOptions && (
        <div className='bg-blue-starter border-blue-backgraund absolute min-w-full overflow-hidden rounded-[20px] border-2'>
          {options.map((option) => (
            <div
              onClick={() => {
                onChange(option);
